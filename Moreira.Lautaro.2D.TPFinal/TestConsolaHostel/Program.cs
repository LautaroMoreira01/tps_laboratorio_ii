...
namespace TestConsolaHostel
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Empleado e1 = new Empleado("Daniel", "Carpio", 40215478, 40, ESexo.Masculino, EPuesto.Duenio, 300000);
            Empleado e2 = new Empleado("Dario", "Mendez", 41657852, 25, ESexo.Masculino, EPuesto.Limpiador, 60000);
            Empleado e3 = new Empleado("Juan", "Carpio", 43054784, 24, ESexo.Masculino, EPuesto.Gerente, 100000);
            Empleado e4 = new Empleado("Martina", "Carpio", 43657852, 30, ESexo.Femenino, EPuesto.Administrador, 100000);
            Empleado e5 = new Empleado("Damian", "Gutierrez", 21487952, 20, ESexo.Masculino, EPuesto.Administrador, 70000);
            Empleado e6 = new Empleado("Lucas", "Pastor", 42085485, 35, ESexo.Masculino, EPuesto.Limpiador, 60000);
            ...
            Cliente c1 = new Cliente("Lautaro", "Moreira", 44245787, 20, ESexo.Masculino);
            Cliente c2 = new Cliente("Sebastian", "Rodriguez", 42458976, 25, ESexo.Masculino);
            Cliente c3 = new Cliente("Julieta", "Perez", 42123456, 20, ESexo.Femenino);
            Cliente c4 = new Cliente("Carolina", "Rivero", 43456789, 18, ESexo.Femenino);
            Cliente c5 = new Cliente("Florencia", "Davila", 42457896, 27, ESexo.Femenino);
            Cliente c6 = new Cliente("Juan", "Pereyra", 42457488, 21, ESexo.Masculino);
            Cliente c7 = new Cliente("Micaela", "Diaz", 45789654, 25, ESexo.Femenino);
            Cliente c8 = new Cliente("Lautaro", "Moreira", 44245787, 20, ESexo.Masculino);
